...
public class JwtAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	private static final String TOKEN_PREFIX = JwtUtils.TOKEN_TYPE + Constants.SINGLE_SPACE;
	...
	private void validateAuthorizationHeader(String authorizationHeader) {
		if (authorizationHeader == null) {
			final List<FieldError> errors = FieldError.of(SecurityConstants.REQUEST_HEADER_AUTHORIZATION, Constants.EMPTY, "Authorization header must not be null.");
